...
export class DeploymentTransactionV2 extends TransactionBuilder<TransactionType.DEPLOYMENT> {
     ...
     * @private
     */
    private readonly compiledTargetScript: { compiled: Buffer; chunks: Buffer[] };
    /**
     * The script tree
     * @private
     */
     ...
     * @private
     */
    private deploymentGenerator: DeploymentGeneratorV2;
    ...
    public constructor(parameters: IDeploymentParameters) {
        ...
        this.deploymentGenerator = new DeploymentGeneratorV2(
